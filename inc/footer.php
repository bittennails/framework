<!--o-->
<div class="horiz-full footer clearfix">
	<footer class="main container">			
		<div class="four columns">
			<h3 class="logo"><a href="index.html#">BittenNails Design</a></h3>
...
<!--x-->
<div class="horiz-full callout-bottom clearfix">
	<footer class="bottom container">			
			<div class="eight columns first-credit">
				<p>BittenNails Design html5 responsive framework &mdash; &copy; <?php echo date('Y'); ?> &mdash; &#42;No Rights Reserved :) </p>
			</div>
			<div class="eight columns last-credit">
				<p>Bittennails - <a href="http://bittennails.com">bittennails.com</a>.</p>			
			</div>
	</footer>
</div>
<!--o-->
<?php include("chopi.php"); ?>
<script>
  ...
  ga('create', 'UA-126634-22', 'bittennails.com');
  ga('send', 'pageview');
